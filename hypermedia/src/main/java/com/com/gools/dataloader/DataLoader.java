package com.com.gools.dataloader;

import com.com.gools.data.*;
import com.com.gools.repo.*;
...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
      ...
      /*  Vector<DepTask> ab = (Vector<DepTask>) dtr.findAll();
        Date x = new java.sql.Date(System.currentTimeMillis());
        Date y = new java.sql.Date(System.currentTimeMillis()-15);
        Date z = new java.sql.Date(System.currentTimeMillis()+15);*/
